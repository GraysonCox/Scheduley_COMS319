...
public class Controller implements Initializable {
	...
	private void initializeTree() {
		Floor floor1 = new Floor(new Image("/edu/iastate/graysonc/scheduley/floorplan1.jpg"));
		floor1.setName("Floor 1");
		Floor floor2 = new Floor(new Image("/edu/iastate/graysonc/scheduley/blanche.jpg"));

...
public interface UserDAO {
	...
	void insertUser(int id, String email, String name, UserType userType) throws SQLException;
	void insertUser(int id, String email, String name, String userType) throws SQLException;

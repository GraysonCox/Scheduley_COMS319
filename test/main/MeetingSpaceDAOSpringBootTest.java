...
//		tla.setUniqueID(1);
		...
		creativeSpace = new MeetingSpace("Meetings/Creative Area", 88, 40, 213, 113, 671);
		creativeSpace.setUniqueID(5);
		
		lab = new MeetingSpace("Conference Room", 88, 153, 139, 119, 672);
		lab.setUniqueID(6);
		
		breakArea = new MeetingSpace("Thien's Happy Space", 307.0, 47.0, 61.0, 101.0, 673);
		breakArea.setUniqueID(7);
		
		retreat = new MeetingSpace("My Crib", 471.0, 283.0, 115.0, 114.0, 673);
		retreat.setUniqueID(8);
		
		tla = new MeetingSpace("THUEJOW", 200, 300, 50, 60, 678);
		tla.setUniqueID(1);
	}
	
	@Test
	void add() {
		meetingSpaceDAOSB.addMeetingSpace(creativeSpace);
		meetingSpaceDAOSB.addMeetingSpace(lab);
		meetingSpaceDAOSB.addMeetingSpace(breakArea);
		meetingSpaceDAOSB.addMeetingSpace(retreat);
		meetingSpaceDAOSB.addMeetingSpace(tla);
	}
//
//	@Test
